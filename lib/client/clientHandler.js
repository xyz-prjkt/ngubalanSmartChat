...
import { dateTimeFormat, tglSuratFormat } from "../utils/commonUtils.js";
  ...
  client.on("message", async (msg) => {
    try {
      ...
      if (msg.body === ".menu") {
        ...
        if (userData) {
          await createSK(
            "SK_" + userData.nama + "_" + dateTimeNow,
            userData.nama,
            userData.nik,
            userData.ttl,
            userData.agama,
          ...
          client.sendMessage(
            ...
            MessageMedia.fromFilePath(
              `${process.env.DATA_DIR}SK/SK_${userData.nama}_${dateTimeNow}.pdf`
            ),
            {
